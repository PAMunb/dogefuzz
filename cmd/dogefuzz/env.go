...
func (e *env) MultiObjectiveGreyboxFuzzer() interfaces.Fuzzer {
	if e.multiObjectiveGreyboxFuzzer == nil {
		e.multiObjectiveGreyboxFuzzer = fuzz.NewMultiObjectivereyboxFuzzer(e)
	}
	return e.multiObjectiveGreyboxFuzzer
}
